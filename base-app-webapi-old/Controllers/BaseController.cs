...
namespace base_app_webapi.Controllers
{
    ...
    //    public BaseController(IServiceManager serviceManager, ILogger logger)
    //    {
    //        this.logger = logger;
    ...
    //    //public void Log(string message, Microsoft.Extensions.Logging.LogLevel logLevel, Microsoft.AspNetCore.Routing.RouteValueDictionary routeValueDictionary)
    //    //{
    ...
    //    public void Log(string message, Microsoft.Extensions.Logging.LogLevel logLevel, string controllerName, string actionName)
    //    {
    //        switch (logLevel)
    //        {
